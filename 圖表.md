...
graph TD
    ...
    %% 封印記憶
    B["被夕封印的記憶<br/>深層潛意識"] --> B1["5歲時的真相<br/>誤殺花子的瞬間<br/>自己的力量失控"]
    B --> B2["蒼的存在<br/>原初的家庭溫暖<br/>完整的愛"]
...
graph TD
    ...
    %% 各角色的位置
    C --> M["二號(朱音)<br/>停留在:習慣化<br/>活著但已死<br/>奪回控制權"]

    C --> N["三號(操)<br/>停留在:腐蝕初期<br/>精神分裂中<br/>完美執念反噬"]

    C --> O["四號<br/>停留在:習慣化<br/>無法承受<br/>選擇自殺"]
...
graph TD
    ...
    F --> F2["三號(操)<br/>態度:完美執念<br/>困境:無法接受<br/>真實的自己"]
