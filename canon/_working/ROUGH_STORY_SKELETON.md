# ROUGH STORY SKELETON
Version: v3 | Updated: 2026-03-23 | Stability: ~95%

每個項目標記：AUTHOR_CONFIRMED / SOURCE_SUPPORTED_BUT_NOT_CONFIRMED / INFERRED / BLOCKED

---

## Skeleton Table

| Structural Slot | Content | Status |
|----------------|---------|--------|
| **Starting State** | Beta 線世界（晴香5歲改變現實後的版本）。晴香是偶像少女，夢想治療他人。美夜子以黑貓形態引導她成為魔法少女。世界看似正常，但屍骸化現象擴散。 | AUTHOR_CONFIRMED |
...
## 角色終局（AUTHOR_CONFIRMED 部分）

| 角色 | 終局 | 狀態 |
|------|------|------|
| 黑奏 | 消散（彩「我想自己揀」否定其存在意義） | AUTHOR_CONFIRMED |
| 彩 | 永恆輪迴，自選，每次阻止黑奏誕生 | AUTHOR_CONFIRMED |
...
- v1（2026-03-22）：初版
- v2（2026-03-23）：整合 aya/saku/aeri canon
- v3（2026-03-23）：整合 backup 三份文件；確認朔弧光、愛莉雙形態、操最終選擇
