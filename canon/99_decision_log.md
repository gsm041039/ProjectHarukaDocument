...
### <a id="decision-cft20"></a>CF-T20: 紫音（不知火紫音）Alpha 原傷及 Beta 軌跡

**矛盾**：Canon `iwakura_akane.md` 未以五步模板結構化紫音的原傷路徑。

**裁決**：**採納（A）**，寫入 `iwakura_akane.md`：
- **Alpha 原傷**：母親重度吸食情緒膠囊，紫音無力阻止
- **童願**：「如果我夠強，她就不用食藥。」
...
### <a id="decision-cft28"></a>CF-T28: 紫音屍骸女皇機制

**矛盾**：`test.txt` 提出紫音可召喚/操控屍骸的「屍骸女皇」機制。
