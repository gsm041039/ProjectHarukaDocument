...
**腐蝕視覺例外說明（設計者注意事項）**：美夜子的腐蝕表現為**紫黑色凍傷／壞死斑塊**，而非 canon/06 §section-law-corruption 定義的標準結晶化。此為刻意的特殊例外——其靈魂在 Alpha 線以冰凍方式死亡，再以 Beta 線保存的靈魂屬性令腐蝕遵循「凍傷」而非「結晶化」的視覺邏輯。任何描繪美夜子腐蝕的內容**必須**使用凍傷紋理，嚴禁改用通用結晶化視覺。**See also**: [§腐蝕法則](../06_visual_bible.md#section-law-corruption)
