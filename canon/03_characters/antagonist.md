...
**步驟一：製造毒藥型情境**
在目標的生活或戰鬥路徑上創造只能依賴負向情緒（憤怒、絕望、恐懼）作為燃料的情境。目標越依賴毒藥型燃料，心之器的腐蝕越快。黑奏不直接攻擊目標的意志——她攻擊目標「維持的情境」，迫使對方主動選擇毒藥型應對。

**步驟二：在目標路徑上放置鏡子**
當目標已被毒藥型情境滲透後，在其視線路徑上製造鏡面接觸機會（字面意義的物理鏡子，或隱喻意義的「真相揭示場景」）。鏡面的誠實預測功能（見 [World Rules §rule-irreversible-rules](../01_world_rules_and_costs.md#section-irreversible-rules)）此時發揮作用——目標在鏡中看見自己腐蝕後的可能未來。

**步驟三：讓鏡面的誠實造成傷害**
當目標被鏡面真相衝擊後，黑奏的最後宣告：「**不係我讓你變成咁。係你自己嘅選擇。**」（粵語原台詞）——這句話是技術上精確的：確實是目標自己選擇了那些情緒和行動。但黑奏故意省略了「她主動製造了那個只有毒藥型選擇的情境」這一事實。

**弱點**：整合者（The Integrator）類型的角色對此三步戰術有天然抵抗——整合者能同時持有矛盾情緒，因此無法被「迫入只能依賴毒藥型燃料」的情境。這是晴香在 Act IV 對抗黑奏時的核心能力依據。**See also**: [整合者](../02_glossary.md#term-integrator)
