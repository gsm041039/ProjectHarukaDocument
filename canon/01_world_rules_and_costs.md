...
### <a id="rule-dual-soul"></a>雙靈魂架構（Dual-Soul Framework）

**定義**：每個人天生帶有兩個獨立的靈魂實體，不是「一個靈魂的兩個面向」，而是兩個完整的靈魂：

| 靈魂 | 特性 | 功能 | 常見誤解 |
|------|------|------|---------|
| **主靈魂（Primary Soul）** | 與理性意識同步 | 日常決策、社交展演、理性思考 | 就是「真實的自己」？其實不一定 |
| **潛意識靈魂（Unconscious Soul）** | 與情感衝動同步 | 非理性欲望、被壓抑記憶、情緒真實 | 就是「魔鬼」或「獸性」？其實是平等的靈魂 |

**關鍵規則**：
- 正常狀態下，兩靈魂在意識層面高度整合，個體感受不到「兩個自己」的分離感
- 両靈魂需要維持連結；連結越強，個體越能整合行為與情感
- 當連結被暴力破壞（例：極端創傷、魔法介入），兩靈魂可能分裂成獨立人格

**例子**：
- 晴香與夕：幼年創傷導致兩靈魂分裂，潛意識靈魂具現化為獨立人格「夕」
- 操：被改造時兩靈魂連結被強制調律，導致人格分裂

**See also**: [Timeline: 夕の誕生](04_timeline_canon.md#event-yu-birth) | [Haruka](03_characters/haruka.md#section-wnlt)
...
- 例：操試圖對他人說出「我一直是女孩」時，只發出「我……我……（沉默）」——聲音在最關鍵的詞語上消失
...
| **負向** | 毒藥型燃料（Poison-Type） | 憤怒、絕望、憎恨、復仇心 | **持久存在** | 施展後持續積累在心之器中，加速腐蝕 |

**核心差異**：
- 繃帶型燃料雖然消耗快，但不會「毒害」心之器；魔法少女可以長期依賴正向情緒而不破裂
- 毒藥型燃料雖然持久，但每次使用都會在心之器內沉澱毒素；即使暫時不用，毒素仍會積累腐蝕
...
7. **鏡像法則**：鏡子反映的 Alpha 線真相無法被覆寫
   - **腐蝕預言補充**：當角色的心之器被負向情緒深度腐蝕時，鏡面還會顯示「該角色如果繼續下去可能到達的腐蝕狀態」——這不是敵人的幻術，而是鏡面對心之器現實狀態的誠實投射。例：晴香在極度憤怒時可能在鏡中看見燃燒黑色眼睛的自身倒影（與黑奏特徵相同）；這是晴香距離「成為自己所恨之物」的距離測量，是鏡面對她的警告，非敵方操控。此機制適用於所有角色。
