...
| **死亡處理** | 靈魂消散，肉體自然腐爛（熵增） | **視乎死亡當刻情緒強度而定（CDL-409）**：一般死亡＝同 Alpha 線一樣靈魂消散、肉體正常腐爛；唯獨死亡當刻情緒極強、極集中、冇人接住＝靈魂連結被異常拉遠，觸發靈魂困禁（CDL-271）與歌德侵蝕封裝為魔法屍骸（詳見[死亡後肉體命運對照](#section-death-comparison)）|
...
**觸發條件（CDL-409，2026-09-19 作者確認，取代舊版「Beta 線死亡一律屍骸化」嘅無差別讀法）**：Beta 線嘅死亡預設同 Alpha 線一樣——靈魂消散、肉體正常腐爛。只有死亡當刻情緒極強、極集中、冇人接住嘅少數案例，先會令靈魂與心之器嘅連結被異常拉遠、未能完全斷開，觸發下表右欄嘅屍骸化路徑；絕大多數死亡不受影響。

| 狀態/現象 | Alpha 線 / Beta 線一般死亡（物理因果主導） | Beta 線異常死亡（死亡當刻情緒極強、冇人接住） |
|---|---|---|
| **死亡定義** | 大腦停止→靈魂消散，物理終結 | 靈魂與心之器連結未能完全斷開→靈魂困禁（CDL-271） |
| **肉體結局** | 自然腐爛（熵增）；回歸化學物質循環 | 世界底層法則強制介入，封裝為魔法屍骸——外顯形態係歌德尖刺侵蝕，並非一般腐爛（見下方「歌德形態嘅來源」）|
| **靈魂處理** | 直接消散；無殘留執念可被錨定 | 被執念錨定者＝以 1% 控制力對抗 99% 情緒廢料（有意識屍骸）；全無執念者＝靈魂仍完全離開，但肉體同樣被強制封裝成「無主容器」空殼（見[靈魂距離光譜](#rule-soul-distance-spectrum)） |
| **集體潛意識反應** | 無——靜默模式無法具現死亡創傷 | 強制介入——將肉體編碼為「情緒廢料容器」並維持其 Beta 線物理存在 |

**歌德形態嘅來源（CDL-409，源自 AC-10／2026-08-29 討論記錄）**：屍骸化嘅外顯形態係歌德尖刺侵蝕，唔係一般腐爛，原因唔係「痛苦積累」本身——而係晴香 5 歲創世嗰刻，將自己對黑暗歌德嘅恐懼直接寫入咗 Beta 線世界底層物理；因為佢力量極大，呢個寫入一直維持並蓋過其他人嘅寫入，令呢個世界嘅「死亡後失控形態」一直都係歌德樣。**哥德唔一定等於「呢度積咗好多痛苦」**——歌德形態係晴香個人恐懼嘅具現化，情緒債務／緋潮係另一條獨立但可疊加嘅線，兩者唔係同一件事。

**命題（CDL-409 修正）**：Beta 線的魔法屍骸不是無差別的死亡結果，而是「一個拒絕接受死亡的世界」在死亡當刻承載了過量、無人承接的情緒時，所製造出的悲劇性妥協方案——絕大多數死亡依然平靜、正常地過去，只有那些帶著極端未處理情緒離世的人，才會撞上這個機制。

**See also**：[屍骸化與修正力](#rule-corpseification) | [靈魂距離光譜](#rule-soul-distance-spectrum) | [2026-08-29 討論記錄 AC-10](../_working/2026-08-29_BETA_WORLD_LAYERS_AND_REIFICATION_DISCUSSION_LOG.md)
