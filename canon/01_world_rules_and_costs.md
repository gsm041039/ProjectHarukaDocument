...
| 階段 | 代表人物 | 體制 | 結果 |
|-----|---------|-----|------|
| 零：原型體 | 黑奏 | — | 帝國軍用情緒技術體系（情緒力量裝置／Emo-Visor／離解兵器）的源頭——被活體解剖逆向工程（79-103年，戰場異常回收研究的產物）。**註（CDL-389）**：綾小路家族另有一條獨立技術線（見[操角色檔](03_characters/ayakomoji_misao.md#母親完美的活體人偶)），源頭獨立於此軍用體系；兩者均建基於晴香創世（102年）之後「情緒/生理可被技術操控」呢個大前提，各自摸索出唔同技術路徑，從未交叉 |
...
| 二：放養實驗體（當前） | 晴香、紫音、操 | [潘朵拉協議](02_glossary.md#term-pandora-protocol) | 策略轉向：不再直接搜索容器，改為耐心培養晴香做「中央節點」——三階段終極目標一致（尋回螢），僅手段演化 |
...
母愛的琥珀當少女與力量建立連結時，一部分靈魂本質在現實世界「凝鑄成形」，形成獨一無二的小盒子/墜飾。材質、雕花、紋路直接反映少女靈魂特質。
...
**可逆性——主線同失敗時間線嘅分別**：主線入面，呢個消解狀態係**暫時、可逆**嘅——當事人可以喺後續劇情被拉返（例：[秋穗](03_characters/akiho.md#section-archetype)喺Act II以「悲鳴女妖」形態出現兩次，其後身份揭露、記憶恢復，繼續行落去第三/四幕）；但喺冇晴香介入嘅失敗時間線（見[秋穗的循環](04_timeline_canon.md#event-akiho-time-loop)），冇任何嘢將佢拉返，消解狀態最終變成永久終局。兩條時間線用嘅係同一條法則、同一個機制，分別只在於有冇一股外力將人拉返。
...
**靈魂距離光譜（統一「靈魂困禁」與「無主容器」）**：以上「靈魂被困」並非唯一結果，而係「靈魂逃離本能」呢條因果線斷裂程度嘅其中一個讀數。0.1 秒決定時刻嘅執念錨點強度，決定靈魂最終停喺光譜邊個位置：
