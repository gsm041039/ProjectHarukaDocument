...
「我選擇停留在我想停留的位置。這是我的態度。」——這句話同時回應[三位一體光譜](../02_glossary.md#term-trinity-spectrum)的三重意義：性別認同（停留在自己選擇的性別）、生死邊界（停留在人與屍骸之間）、[態度 vs. 命運](../02_glossary.md#term-attitude-vs-fate)（以選擇定義存在）。
...
- 選擇停留就是[態度](../02_glossary.md#term-attitude-vs-fate)自由——存在的意義由自己定義
...
- [Dark Healing](../02_glossary.md#term-dark-healing) — 治癒敘事的核心定義
