...
| 5 | 鏡像處刑室 | 114年4月 Act III Phase H | CDL-233 Stage 2a；[待確認CDL] | SPEC#26被遺棄（紗夜犧牲）→ 操在無窮鏡面中崩潰 → 砸碎鏡子→SPEC#31回歸真實 |
...
| 12 | 集體潛意識之城 | 114年 Act II-III | [待確認CDL]；E-11 | E-11潛意識風暴觸發 → 後巷唐樓扭曲成超現實痛苦世界 → SPEC#20紙皮騎士防禦 |
| 13 | 靜止搖籃終局 | 114年5-6月 Act III-IV交界 Phase K | [待確認CDL靜止搖籃] | SPEC#19帝國廣場崩塌；SPEC#50最終抉擇 → 晴香粒子化成新世界錨點 → Act IV Phase L（20年後）|
| 14 | 凜的雙面形態 | 113年4-5月 Act II Phase A | CDL-215；E-05 | 108年凜犧牲→黑奏重組→E-05美夜子認出 → 孔雀vs烏鴉雙面日常 → Act III H2 Unit 00揭露 |
| 15 | 朔的日夜對比 | 113-114年 Act II-III | `saku.md`；[待確認CDL] | 朔雙重身份背景 → 日夜兩個形態並置 → Act III朔正式加入主角團 |
...
| 28 | 緋潮反噬 | 114年4月末 Act III Phase H-I | Alpha/Beta線衝突；[待確認CDL] | 晴香多次改變現實積累因果代價 → Alpha/Beta線物理撕裂 → SPEC#50最終抉擇 |
...
| 32 | 美夜子的貓殼復原 | 113-114年 Act II | CDL-282；[待確認CDL] | 避難所詛咒觸發後日常 → 鏡前看到腐爛透視真實自我 → SPEC#6月下崩潰 |
| 33 | 晴香的城市獨行 | 113年3月 Act I Beat 0 | CDL-131/171/180 | Beat 0家中出發 → 日區街道廣告牌，隔著玻璃的疏離 → SPEC#21光幕破碎（同一城市，完全相反）|
| 34 | 美夜子與小光的對話 | 113年3-4月 Act I | `miyako.md`；[待確認CDL] | Act I初期輕鬆段落 → 貓形態美夜子與小光的溫馨互動 → SPEC#22小光死亡的情感反差 |
| 35 | 凜的情報蒐集現場 | 113年 Act I-II | CDL-215；重組後公務員 | SPEC#24人性消磨 → 以烏鴉形態監視主角團（她不知道自己在監視前「家人」）→ Act III Phase G追捕揭露 |
| 36 | 朔與黑市網絡 | 113年9月-114年1月 Act II Phase D-E | `saku.md`；[待確認CDL] | 朔雙重身份背景 → 黑市交易，維持日夜身份平衡 → Act III朔正式加入；困獸的慈悲（候選K）|
...
| 39 | 朱音的糖果成癮 | 113年初 Act I-II | `akane.md §糖果成癮`；[待確認CDL] | 弟弟誤食情緒結晶死亡（前史）→ 糖果堆滿房間的逃避日常 → SPEC#4廢棄糖果工廠（成癮升級）|
...
| 45 | 黑奏的帝國寶座 | Act III | CDL-076；[待確認CDL] | 黑奏篡位帝國（前史）→ 148cm幼女坐巨大紫黑王座 → 三武器揭露（SPEC#3）的形態前置 |
...
| 50 | 晴香的最終抉擇瞬間 | 114年5-6月 Act IV分歧點 | [待確認CDL] | SPEC#28緋潮反噬後 → 現實戰鬥vs夢境循環的分岐 → SPEC#13靜止搖籃（選擇後）|
...
| 53 | 朔的雙刃生存 | 113-114年 Act III-IV | `saku.md`；[待確認CDL] | 朔雙重身份全片積累 → 日夜交界，兩個身份合體 → Act IV朔的終局 |
| 54 | 靜止搖籃的粒子化進程 | 114年5-6月 Act IV | [待確認CDL] | SPEC#13靜止搖籃（決定瞬間）→ 晴香逐漸粒子化的過程圖 → SPEC#56新世界搖籃曲 |
| 55 | 美夜子的靈魂雙線 | 114年 Act III-IV | `miyako.md`；[待確認CDL] | 美夜子Act III覺醒 → 靈魂分裂為人類線×貓殼線 → 最終交織，SPEC#FF哭泣（候選）|
| 56 | 新世界的搖籃曲 | 134年7月 Act IV Phase L | `05_story_outline_canon.md §Phase L` | 所有場景的積累 → 晴香化身新世界規則，角色各自繼續 → （故事結束）|
| 57 | 黑暗沖涼習慣 | 113-114年 日常 | `miyako.md §私密習慣`；[待確認CDL] | 避難所詛咒觸發後日常 → 完全黑暗淋浴，觸覺確認身體存在 → SPEC#6月下崩潰（「我還是人嗎」）|
...
| 61 | 強迫清洗儀式 | 113-114年 日常 | `misao.md §強迫清洗`；[待確認CDL] | SPEC#26被遺棄（父親出賣）→ 強迫清洗手洗去罪惡感 → SPEC#5鏡像處刑室（無法洗淨的根源）|
| 62 | 透明物執著 | 113-114年 日常 | `haruka.md §習慣`；[待確認CDL] | Act I開始 → 蒐集透明物，透過觀察他人 → 晴香「看不透自己」主題的日常具現 |
| 63 | 睡前熱可可成癮 | 113-114年 日常 | CDL-123；CDL-128 | CDL-123設定 → 每晚精確熱可可，召喚虛假童年 → Act IV K期靈魂監獄（同樣的儀式，20年重複）|
| 64 | 嚼冰塊危機 | 113-114年 日常 | `haruka.md §習慣`；[待確認CDL] | 焦慮積累 → 嚼冰塊以痛確認存在 → SPEC#65破弦自傷（同機制的升級）|
...
| 68 | 儀器掃描愛莉遺物 | 113-114年 日常 | `akiho.md`；`aeri.md §石像`；[待確認CDL] | 秋穗實驗室事故（98年）→ 每日反覆掃描愛莉遺物試圖重建 → Act III秋穗罪疚爆發 |
...
| 71 | K房唱歌傷痕 | 113-114年 日常 | `miyako.md §習慣`；[待確認CDL] | 避難所詛咒觸發後 → 廢棄K房尖叫唱歌至喉嚨流血 → SPEC#57黑暗沖涼（同一個「身體確認」機制）|
| 72 | 長泳窒息習慣 | 113-114年 日常 | `miyako.md §習慣`；[待確認CDL] | 貓殼詛咒後 → 潛水延遲浮起，體驗死亡邊界 → SPEC#6月下崩潰（「我是人類嗎」的日常版）|
| 73 | 家長日大作戰 | [待定] Act II前期 | [待確認CDL] | 操加入主角團後 → 偽裝成紫音的高貴家長出席家長日 → 輕鬆喘息段落，反差前置後段沉重 |
| 74 | 甜品局掉牙 | 113-114年 日常 | CDL-233 Stage 2b；SPEC#74→N | 操Body Horror積累 → 甜品局悄悄掉牙，完美笑容遮蔽恐懼 → 候選N「操絲線縫牙」（同一強迫症升級）|
| 75 | 刑思殺出實驗室 | 前史 98年前後 | `aya.md §數據養殖`；`01_world_rules §實驗鏈`；[待確認CDL] | 黑奏長期作為活體實驗品，螢已犧牲 → 覺醒力量，屠殺所有實驗人員 → 黑奏弒父篡位（候選D）；SPEC#3三武器根源 |
| 76 | 凜×美夜子黃金搭檔 | 前史 103-108年 | `rin.md §羈絆`；CF-TIME-rin-pre；[待確認CDL] | 兩人被軍方武器化 → 默契巔峰，back-to-back，不需語言的信任 → SPEC#77犧牲的情感重量 |
| 77 | 凜殿後最終犧牲 | 前史 108年 | `rin.md §犧牲`；CF-TIME-0068；[待確認CDL] | SPEC#76黃金搭檔（黃金態）→ 凜主動引開L3光環，頸椎被扭斷，眼神釋然非恐懼 → 美夜子終身PTSD；Act III H2凜拒絕治癒 |
...
|-------|--------|--------|---------|----------------------|------|
| A | 鐵絲網偶遇（5歲晴香×被困彩）| 前史 102年 | CDL-288/289；CF-TIME-0013 | 黑奏篡位，彩被困 → 5歲晴香透過鐵絲網看見被困的彩 → 晴香許願（創世的根源）| ★★★★★ |
| B | 通風管道那夜（螢的犧牲）| 前史 79年 | `aya.md §螢`；`02_glossary.md #hotaru` | 帝國實驗對螢進行最終處置 → 螢在通風管道犧牲，把熊公仔交給黑奏 → 黑奏整個人生的動力根源 | ★★★★★ |
| C | 帝國實驗室：黑奏作為活體樣本 | 前史 98年前後 | `aya.md §數據養殖`；`01_world_rules §實驗鏈` | 帝國發現黑奏是魔法少女 → 心匣被強制解析、數據化 → SPEC#75覺醒屠殺（同一個實驗室，不同瞬間）| ★★★★ |
| D | 黑奏弒父篡位 | 前史（覺醒後）| `aya.md §篡位`；`01_world_rules §帝國歷史` | SPEC#75覺醒屠殺後 → 148cm幼童站在巨大王宮弒殺養父 → 帝國「刑思」法號確立；黑奏對螢的永恆追求的開始 | ★★★★★ |
...
| G | 美夜子Glitch Form首次 | 113年4-5月 Act II Phase A | CDL-282；E-05a；`miyako.md §Unit 01` | E-05美夜子認出凜（PTSD觸發）→ 貓殼龜裂，0.5秒閃現人形 → SPEC#6月下崩潰（貓殼龜裂三段第一段）| ★★★★★ |
| H | 小光之死+黑奏邏輯侵入 | 113年5月 Act II Phase B | E-07a；`aya.md §數據養殖` | 小光死亡（SPEC#22）的同時 → 紫音防衛崩潰，黑奏文字滲入畫面邊緣 → 紫音被黑奏邏輯說服的心理入口 | ★★★★★ |
| I | 廢棄糖果工廠三人辯論 | 113年5-6月 Act II Phase B | E-07b；[待確認CDL] | E-07b紫音被放逐後 → 晴香、紫音、操三種哲學在腐爛糖果空間對峙 → 各人弧光的中間衝突 | ★★★★★ |
...
| M | 王國邊緣的盛宴（紫音獨處）| Act II Phase D E-11前 | `akane.md §嘆息之橋前`；[待確認CDL] | E-07b被放逐、小光已死 → 紫音在帝國廣告光下獨自餵食流浪貓，攝取腐爛糖果 → SPEC#10犧牲情感前置 | ★★★★★ |
| N | 操絲線縫牙 | Act II Phase A-B | CDL-233 Stage 2a | 操Body Horror Stage 1→2a轉換 → 鏡前用傀儡絲縫鬆動牙齒，外表完美/內部恐怖 → SPEC#74甜品掉牙的前置（還未掉只是縫）| ★★★★★ |
...
| R | 飢餓的天使——直播失控（半屍骸）| 113年7月 Act II Phase C E-09 | E-09；CDL-180；夕接管 | E-08恐怖家家酒高壓 → 半屍骸左手在直播舞台吸取情緒，夕接管瞬間 → SPEC#21光幕破碎（同一事件不同鏡頭）| ★★★★★ |
| S | 黑奏農場觀察 | Act II Phase B E-08 | CDL-211；CDL-079 | SPEC#11茶會 → 黑奏精算晴香情緒增幅器的農場視角 → 黑奏「情緒農場」意識形態的視覺化 | ★★★★ |
| T | 鏡像相簿異變 | Act II Phase B [NC] | `08_narrative §P-C10鏡像相簿`；[待確認CDL] | SPEC#30違和感（倒影慢0.3秒）→ 晴香看見玻璃台面反射中的藍色馬尾殘影 → SPEC#2整合場景（殘影的真正身份）| ★★★★ |
| U | 操の虛榮告白 | Act II Phase A E-05a後 | `misao.md §隊伍融入`；[待確認CDL] | 操被迫加入主角團初期 → 完美妝容下眼眶微紅，第一次放下傲慢 → 操弧光「從形式主義到真實」第一步 | ★★★★ |
| V | 朔看見Unit 01的臉 | Act II Phase D | `saku.md §美夜子`；[待確認CDL] | 朔過去與美夜子的關聯（[待確認CDL]）→ Unit 01任務中，朔認出美夜子的臉 → 朔的動機和CDL-274相關線 | ★★★★ |
| W | 凜的最終選擇（Unit 00-Null揭露）| 114年4月 Act III Phase H2 | E-15a（凜拒絕治癒）；CDL-215 | 凜發現自己頸部角度異常→自我認知 → 晴香伸出手，凜推開，「我選擇留在Unit 00」→ 美夜子的終極PTSD觸發 | ★★★★★ |
| X | 嘆息之橋——凜獨角 | 114年 Act III Phase G-H之間 | `rin.md §嘆息之橋`；`04_timeline §嘆息之橋` | 凜已知自己是重組體，尚未揭露 → 橋上獨處，她已決定 → 候選W最終選擇（她在這裡就決定好了）| ★★★★ |
| Y | 操の被迫報串 | 114年 Act III Phase H | CDL-298；`misao.md` | SPEC#26被遺棄（紗夜犧牲）；SPEC#J紗夜犧牲 → 傀儡絲手指在通訊器上懸停，最深罪疚 → SPEC#1鋼鐵獨舞（帶著這個罪疚在跳的最後一支舞）| ★★★★ |
...
| EE | 屍骸覺醒——L4 | 114年 Act III Phase L4 | `05_outline §L4`；[待確認CDL] | Phase L4觸發條件（[待確認CDL]）→ 空洞眼睛逐一亮起人類的光 → Act IV新世界建立 | ★★★★ |
...
| LL | 靈樹：平時狀態 | 世界觀設定 | `02_glossary #spirit-tree`；`01_world_rules` | — → 夜區谷地老樹，普通感是伏筆 → Act III Phase J決戰中靈樹作用（[待確認CDL]）| ★★★★ |
| MM | 帝國廣場常態 | 世界觀設定 | `06_visual_bible §帝國廣場`；`07_entities` | — → 非戰鬥展示秩序空間，麻木市民 → SPEC#19決戰崩塌；SPEC#49市民凝滯的對比 | ★★★★ |
| NN | Emo-Visor集體成癮 | 世界觀設定 | `02_glossary #emo-visor`；[待確認CDL] | — → 日區咖啡廳，全城Emo-Visor過濾版幸福感 → Act II光幕體系的日常具現；SPEC#21破碎的前置 | ★★★★ |
...
**簡化描述**（150-200字）：
小光在朱音面前被屍骸襲擊，身體在崩潰中轉化為廢鐵型屍骸。這一刻朱音內心崩潰，她無法保護最重要的人，最後的希望在此破碎。視覺上呈現血與機械零件混雜。
...
- **CDL追蹤**：[待確認CDL]；`canon/01_world_rules_and_costs.md §實驗鏈演進`；`canon/03_characters/aya.md §數據養殖計劃`
...
- **CDL追蹤**：[待確認CDL]；`canon/03_characters/rin.md §與美夜子的羈絆`；`canon/04_timeline_canon.md #event-rin-sacrifice`
...
- **CDL追蹤**：[待確認CDL]；`canon/03_characters/rin.md §犧牲——光環處決`；`canon/04_timeline_canon.md #event-rin-sacrifice`；CF-TIME-0068（凜犧牲事件條目）
...
- **CDL追蹤**：E-07b；[待確認CDL]
- **前置事件**：紫音被放逐（E-07b），晴香和操試圖找到她，在廢棄糖果工廠相遇
